				...
				echo '</select>';
                                ...
                                if (isset($_SESSION['id_usuario'])) {
                                    ...
                                    //if($_COOKIE['nodstrumCalendarV2']) {
                                            echo '&nbsp;&nbsp;<a href="#" onClick="showCP();">Painel Controle</a>';
                                    }
//                                    else {
...
//                                    }
		...
		echo '<div class="calendarFloat" style="text-align: center; background-color: #'. $dayColor .';"><span style="position: relative; top: 4px;">Seg</span></div>
				...
				<div class="calendarFloat" style="text-align: center; background-color: #'. $weekendColor .';"><span style="position: relative; top: 4px;">Sáb</span></div>
	...
	case 'listEvents':
		...
		if($eventQuery) {
			if(mysql_num_rows($eventQuery) >0) {
				echo '<br><b>Eventos do dia: '. date("d", $timeStamp) .'/'. date("m", $timeStamp) .'/'. date("Y", $timeStamp) .'</b>';
				...
				echo 'Não há eventos neste dia.';
			}
		} else {
			echo 'Erro ao obter os resultados.';
		}
